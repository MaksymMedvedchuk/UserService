...
import com.example.userservice.core.domain.dto.ApiErrorDto;
import com.example.userservice.core.service.exception.ApiError;
import com.example.userservice.core.service.exception.DuplicateEmailException;
import com.example.userservice.core.service.exception.MinorUserException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		List<ApiError> errorMessages = bindingResult.getFieldErrors().stream()
	...
	public ResponseEntity<ApiErrorDto> handlePSQLException(PSQLException ex) {
		String field = ex.getSQLState().equals(ApiConstants.SQL_STATE) ? ApiConstants.EMAIL : ApiConstants.CONSTRAINT_FIELD;
