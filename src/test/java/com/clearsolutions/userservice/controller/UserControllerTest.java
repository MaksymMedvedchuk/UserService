package com.clearsolutions.userservice.controller;

import com.clearsolutions.userservice.core.converter.UserDataConverter;
import com.clearsolutions.userservice.core.domain.dto.ResponseDto;
...
public class UserControllerTest {
	...
	@Test
	public void givenValidUserData_whenCreate_thenUserIsCreated() throws Exception {
	...
	@Test
	public void givenInvalidUserData_whenCreate_thenReturnBadRequest() throws Exception {
	...
	@Test
	public void givenNonExistingUserId_whenDelete_thenReturnUnprocessableEntity() throws Exception {
		Mockito.doThrow(ResourceNotfoundException.class).when(userService).delete(id);
	...
	@Test
	public void givenValidUserDataForUpdatingField_whenPatch_thenFieldIsUpdated() throws Exception {
	...
	@Test
	public void givenNonExistingUserId_whenPatch_thenReturnUnprocessableEntity() throws Exception {
	...
	@Test
	public void givenValidUserDataForUpdatingFields_whenUpdate_thenFieldsIsUpdated() throws Exception {
	...
	@Test
	public void givenInvalidUserDataForUpdatingFields_whenUpdate_thenReturnBadRequest() throws Exception {
	...
	@Test
	public void givenInvalidRangeBirthday_whenGetByBirthdayRange_thanReturnBadRequest() throws Exception {
		mockMvc.perform(get("/users")
				.param("startDate", "2023-10-10")
